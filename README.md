...
[You can read the official documentation for more information.](https://docs.axway.com/bundle/api-builder/page/docs/getting_started/index.html)
...
[You can read the official documentation of how to further use the API Builder Console.](https://docs.axway.com/bundle/api-builder/page/docs/getting_started/index.html)
